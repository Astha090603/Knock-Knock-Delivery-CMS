...
<!-- Mirrored from jthemes.net/themes/f-html/GO-Courier/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Apr 2022 10:00:42 GMT -->
<head>
        <title>About KKD</title>
        <meta charset="UTF-8">
                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us pt-10">
                                    <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">
                                        The Knock Knock Courier Service provides pickup and delivery service 24/7. Our goal is to provide a faster, more cost effective delivery of packages to all the customers. The Knock Knock Delivery service can help standardize delivery time.
                                    </p>
                                    <ul class="feature">
                                        <li> 
                            ...
                            <div class="col-md-6 text-center">                                
                                <img alt="" src="assets\img\block\kkd_van.png" class="effect animated fadeInRight" />
                            </div>
                        </div>
                    </div>
                </section>
