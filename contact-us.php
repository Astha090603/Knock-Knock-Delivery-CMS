...
<!-- Mirrored from jthemes.net/themes/f-html/GO-Courier/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Apr 2022 10:00:43 GMT -->
<head>
        <title>Contact / KKD Home</title>
        <meta charset="UTF-8">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 col-md-offset-1">
                                <ul class="contact-detail title-2 pt-50">
                                    <li class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".30s"> <span>India numbers:</span> <p> +91 99999 99999 <br> +91 88888 88888 </p> </li>
                                    <li class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".40s"> <span>usa numbers:</span> <p> +777-7777-777 <br> +666-6666-666 </p> </li>
                                    <li class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".50s"> <span>Email address:</span> <p> support@kkd.com <br> info@kkd.com </p> </li>
                                </ul>
                            </div>
                    ...
                    <div class="theme-container container">               
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <p>Knock Knock Delivery © Copyright 2022, All rights reserved </p>                            
                            </div>
